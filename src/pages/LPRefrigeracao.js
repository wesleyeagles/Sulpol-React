...
function LPRefrigeracao() {
  ...
  return (
    ...
    <div className="relative bg-[#202124]" id="lpheader">
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row justify-between mt-100 lg:mt-200 pb-20">
          <div className="lg:w-[38%] 2xl:w-[35%]">
            ...
            <ButtonLP text="QUERO MAIS PRODUTIVIDADE" />
          </div>
        ...
        <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row justify-between">
                ...
                <div className="w-full lg:w-[40%] mt-16 lg:mt-0">
                    ...
                    <ButtonLP text="QUERO SOLICITAR ORÇAMENTO"/>
                </div>
            </div>
        </div>
      </div>
      ...
      <div className="pt-20 lg:pt-80 bg-[#202124] relative">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row justify-between">
          ...
          <div className="w-full lg:w-[65%] mt-16 lg:mt-0">
            ...
            <ButtonLP text="QUERO OTIMIZAR MINHA PRODUÇÃO"/>
          </div>
        </div>
      </div>
      </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="w-full lg:w-[60%]">
              ...
              <ButtonLP text='QUERO PEÇAS DE QUALIDADE'/>
            </div>
    ...
    <div ref={carousel} className='flex items-center overflow-x-auto gap-8 lg:w-[65%] 2xl:w-[87%] scroll-smooth h-[450px] carouselE'>
            ...
            <img className='lg:w-[70%] 2xl:w-[65%] -top-[50px] mb-10' src={EcologicaAP} />
            <div className='mb-10'>
                ...
                <a className='flex items-center gap-2 text-center justify-center text-lg font-semibold text-sulpol-green' href=''>Explorar <ExplorarArrow className='mt-1' /> </a>
            </div>
            </div>
    ...
    <PrevArrow onClick={handleLeftClick} className='lg:absolute left-0 lg:translate-y-[200px]'/>
    <NextArrow onClick={handleRightClick} className='lg:absolute right-0 lg:translate-y-[200px]'/>
    </div>
    </div>
      ...
      <div className="py-36 bg-[#202124]">
        <div className="container mx-auto">
          ...
          <div className="flex justify-center">
          <HashLink className="border border-[#81D742] text-white py-4 px-20 rounded-lg" to="/#header">VOLTAR PARA O SITE</HashLink>
          </div>
        </div>
      </div>
