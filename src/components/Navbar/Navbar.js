...
function Navbar() {
  ...
  const { menuMobile, setMenuMobile, menuProdutos, setProdutos, ptLang, enLang, esLang, handlePtLangChange, handleEnLangChange } = useContext(ContextProdutos)
  ...
  return (
    ...
    <div className={`bg-white shadow-md h-0 overflow-hidden w-full lg:w-[30%] 2xl:w-1/4 transition-all duration-1000 fixed z-40 ${menuProdutos ? "h-[300px] lg:h-screen  pt-40" : 'pt-0'} ${hideMenu ? "-translate-y-[170px]" : '-translate-y-[0px]'}`}>
      <div className='container mx-auto h-full'>
     ...
     {/*   <HashLink className='w-[100%]' to='/Star300SPV#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>STAR <span className='text-sulpol-green font-bold'>300S-PV</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'><img className='hidden sm:block w-[50px] md:w-[70px] h-full' src='https://uploaddeimagens.com.br/images/003/913/769/full/star300s-pv.png?1656006655'/></div> <MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink> 
       ...
       <HashLink className='w-[100%]' to='/DCPD#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>DCPD <span className='text-sulpol-green font-bold'>LÓGICA AP</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[60px] h-full' src='https://uploaddeimagens.com.br/images/003/924/542/full/Ativo_1.png?1656676377'/> </div><MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink>
       <HashLink className='w-[100%]' to='/Cabecote#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>CABEÇOTES <span className='text-sulpol-green font-bold'>MISTURADORES</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[50px] h-full' src='https://uploaddeimagens.com.br/images/003/924/552/full/Ativo_1.png?1656677238'/> </div><MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink>
       <HashLink className='w-[100%]' to='/Bombas#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[110px]'>BOMBAS DE <span className='text-sulpol-green font-bold'>PU</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[60px] md:w-[70px] h-full' src='https://uploaddeimagens.com.br/images/003/924/560/full/WhatsApp_Image_2022-07-01_at_09.21.51-removebg-preview.png?1656678154'/> </div><MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink>
       <HashLink className='w-[100%]' to='/Porta-Moldes#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>PORTA <span className='text-sulpol-green font-bold'>MOLDES</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[55px] h-full' src='https://uploaddeimagens.com.br/images/003/924/570/full/Ativo_2.png?1656678952'/> </div><MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink>
       <HashLink className='w-[100%]' to='/Paineis-e-Telhas#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[110px]'>PAINÉIS / <span className='text-sulpol-green font-bold'>TELHAS</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[60px] h-full' src='https://uploaddeimagens.com.br/images/003/924/578/full/termoacusticas-removebg-preview.png?1656679360'/> </div><MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink>
       <HashLink className='w-[100%]' to='/Projetos-Especiais#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>PROJETOS <span className='text-sulpol-green font-bold'>ESPECIAIS</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[80px] h-full' src='https://uploaddeimagens.com.br/images/003/924/593/full/Ativo_3-removebg-preview.png?1656680249'/> </div><MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink>
    ...
    <div className={`bg-white shadow-md h-0 overflow-hidden w-full lg:w-[30%] 2xl:w-1/4 transition-all duration-1000 fixed z-40 ${menuProdutos ? "h-[300px] lg:h-screen  pt-36" : 'pt-0'} ${hideMenu ? "-translate-y-[170px]" : '-translate-y-[0px]'}`}>
     ...
     {/*   <HashLink className='w-[100%]' to='/Star300SPV#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>STAR <span className='text-sulpol-green font-bold'>300S-PV</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'><img className='hidden sm:block w-[50px] md:w-[70px] h-full' src='https://uploaddeimagens.com.br/images/003/913/769/full/star300s-pv.png?1656006655'/></div> <MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink> 
       <HashLink className='w-[100%]' to='/Star300SR2436#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>STAR 300S-<span className='text-sulpol-green font-bold'>R24/36</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'><div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[70px] h-full' src='https://uploaddeimagens.com.br/images/003/913/796/full/1123dfd.png?1656007347'/></div> <MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink> 
       <HashLink className='w-[100%]' to='/Star300STG#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>STAR <span className='text-sulpol-green font-bold'>300S-TG</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[70px] h-full' src='https://uploaddeimagens.com.br/images/003/913/802/full/star_300-tg.png?1656007443'/></div> <MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink> */}
       <HashLink className='w-[100%]' to='/DosadoraElastomero#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>ELASTOMERS <span className='text-sulpol-green font-bold'>CASTING MACHINE</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[70px] h-full' src='https://uploaddeimagens.com.br/images/003/913/806/full/ST-ce9.png?1656007569'/></div> <MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink> 
       ...
       <HashLink className='w-[100%]' to='/DosadoraAltapressao#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>HIGH PRESSURE<br/><span className='text-sulpol-green font-bold'>METERING</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'><div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[60px] h-full' src='https://uploaddeimagens.com.br/images/003/913/816/full/ECOLOGICA-AP-100-A_sem_piso.png?1656007765'/></div> <MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink> 
       <HashLink className='w-[100%]' to='/DosadoraBaixapressao#header'><div className='flex w-[100%] sm:w-[31%] md:w-[33%] h-20 lg:w-full lg:h-auto items-center justify-between border-b border-gray-300 lg:pb-3 cursor-pointer'> <h2 className='machine-name text-sm w-full lg:w-[160px]'>LOW PRESSURE <span className='text-sulpol-green font-bold'>METERING</span> </h2> <div className='flex items-center md:gap-5 w-[50%] lg:w-auto'> <div className='w-[70px]'> <img className='hidden sm:block w-[50px] md:w-[60px] h-full' src='https://uploaddeimagens.com.br/images/003/913/817/full/ST-C4A-scaled.png?1656007852'/> </div><MdKeyboardArrowRight color='#81D742' size={20}/>  </div> </div></HashLink>
